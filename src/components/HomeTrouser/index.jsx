...
//Images
import trouserBg from '../../assets/images/trouserBg.jpg'
//
...
const HomeTrouser = () => {
  ...
  const productSort = (e) => {
    ...
    const SortProduct = homeTrouser.slice().sort((a, b) => {
      if (res === "expensive") {
